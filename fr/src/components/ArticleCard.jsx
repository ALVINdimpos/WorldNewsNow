...
export function ArticleCard({ article, onClick, onLike, isLiked, onBookmark, currentUser, setAuthView }) {
  ...
  return (
    <div className="art-card" onClick={onClick}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 15, color: bookmarked ? 'var(--gold)' : 'var(--muted)',
      ...
      <p style={{
        fontSize: 13, color: 'var(--muted)', lineHeight: 1.6, marginBottom: 16,
      ...
      <div style={{
          ...
          <div>
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text)', display: 'flex', alignItems: 'center', gap: 4 }}>
              ...
              {article.author.role === 'journalist' && (
                <span style={{
                  fontSize: 8, background: 'rgba(212,168,83,0.15)', color: 'var(--gold)',
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ fontSize: 12, color: 'var(--muted)', fontFamily: "'DM Mono',monospace", display: 'flex', alignItems: 'center', gap: 4 }}>
...
export function FeaturedArticle({ article, onClick, onLike, isLiked, onBookmark, currentUser, setAuthView }) {
  ...
  return (
    <div onClick={onClick} style={{
      ...
      <h1 style={{
        fontFamily: "'Bebas Neue',sans-serif", fontSize: 'clamp(36px,5vw,60px)',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{
            width: 32, height: 32, borderRadius: '50%', background: 'rgba(212,168,83,0.2)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div style={{ display: 'flex', gap: 12, marginLeft: 'auto', alignItems: 'center' }}>
          ...
          <span style={{ fontSize: 13, color: 'var(--muted)', fontFamily: "'DM Mono',monospace", display: 'flex', alignItems: 'center', gap: 5 }}>
            ◎ {article.commentsCount || 0}
          </span>
          <span style={{ fontSize: 13, color: 'var(--muted)', fontFamily: "'DM Mono',monospace", display: 'flex', alignItems: 'center', gap: 5 }}>
            👁 {article.viewCount || 0}
          ...
          <button
            ...
            style={{
              ...
              fontSize: 17, color: bookmarked ? 'var(--gold)' : 'var(--muted)',
              lineHeight: 1, transition: 'color .15s',
            }}
          >
            {bookmarked ? '🔖' : '🏷'}
