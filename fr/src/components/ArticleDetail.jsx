...
export function ArticleDetail({ 
  ...
  return (
    <div style={{maxWidth:780,margin:"0 auto"}}>
      ...
      <h1 style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:"clamp(36px,6vw,58px)",
      ...
      <p style={{fontSize:16,color:"#B8B4AC",lineHeight:1.7,marginBottom:28,fontStyle:"italic",
