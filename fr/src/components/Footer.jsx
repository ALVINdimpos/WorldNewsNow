  ...
  return (
    <footer style={{
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"48px 24px 32px"}}>
        ...
        {/* Row 2: Sections + Company — always side by side */}
        ...
        {/* Row 3: Subscribe — always full width */}
          ...
          {subDone ? (
            ...
            <div style={{display:"flex",gap:8,maxWidth:420}}>
              ...
              <button className="btn-gold" onClick={handleSubscribe} disabled={subLoading}
                style={{padding:"9px 14px",fontSize:12,borderRadius:8,opacity:subLoading?0.6:1,flexShrink:0}}>
